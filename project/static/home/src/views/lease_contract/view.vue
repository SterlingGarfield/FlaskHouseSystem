				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 租赁合同 -->
							<div><span>租赁合同</span></div>
							<view_lease_contract v-if="$check_action('/lease_contract/view','get')"></view_lease_contract>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import view_lease_contract from "../../components/diy/view_lease_contract.vue";
	export default {
		data() {
			return {
			};
