				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 维修记录 -->
							<div><span>维修记录</span></div>
							<table_maintenance_records v-if="$check_action('/maintenance_records/table','get')"></table_maintenance_records>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_maintenance_records from "../../components/diy/table_maintenance_records.vue";
	export default {
		data() {
			return {
			};
