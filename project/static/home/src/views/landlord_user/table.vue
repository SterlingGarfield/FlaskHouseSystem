				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 房东用户 -->
							<div><span>房东用户</span></div>
							<table_landlord_user v-if="$check_action('/landlord_user/table','get')"></table_landlord_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_landlord_user from "../../components/diy/table_landlord_user.vue";
	export default {
		data() {
			return {
			};
