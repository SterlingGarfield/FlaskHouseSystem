<template>
	<div class="diy_details page_housing_information" id="housing_information_details">
		...
		<div class='warp'>
			<div class='container'>
				<div class='row'>
					<div class='col'>
						<div class='card_housing_information'>
							<div_housing_information :obj="obj"></div_housing_information>
...
<script>
	import div_housing_information from "@/components/diy/div_housing_information.vue";
	...
	export default {
		...
		methods:{
			...
			add_hits(obj) {
				obj["hits"] = obj["hits"] + 1;
				var hits = obj["hits"];
				this.$post('~/api/housing_information/set?housing_information_id=' + obj["housing_information_id"], {
					hits
				}, (res) => {
					if(res.result){
			...
			async get_obj_after(json) {
				...
				if (json && json.result && json.result.obj) {
					...
					this.form_comment.source_id = this.obj.housing_information_id;
																					}
			},
																				/**
			 * 初始化收藏状态
