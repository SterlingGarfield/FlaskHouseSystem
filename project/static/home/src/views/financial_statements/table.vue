				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 财务报表 -->
							<div><span>财务报表</span></div>
							<table_financial_statements v-if="$check_action('/financial_statements/table','get')"></table_financial_statements>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_financial_statements from "../../components/diy/table_financial_statements.vue";
	export default {
		data() {
			return {
			};
