		            ...
		            <div class="col-12">
		                <div class="sw_no">
							...
							<div class="card_notice">
								<div class="notice_title">通知公告 <router-link to="notice/list" class="not_more more"><span class="mor">更多</span></router-link></div>
								<!-- 公告组件 -->
							...
							<!-- 推荐房屋信息模块(开始) -->
		<div class="ins warp model1" v-if="$check_action('/housing_information/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
		                    ...
		                    <div class="more_box">
		                        <router-link to="/housing_information/list" class="ins_more more">
		                ...
		                <!-- 房屋信息推荐列表组件 -->
						<div class="list_housing_information_box" ins_box>
							<div class="Left_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
                        	</div>
							<list_housing_information :list="list_housing_information" />
							<div class="right_box">
								<span class="i"></span>
								<span class="i"></span>
								<span class="i"></span>
...
<script>
	...
	export default {
		...
		methods: {
			...
			toToggle(){
				this.isAdmin = !this.isAdmin;
								...
								// 获取房屋信息列表
			get_housing_information() {
				let url = "~/api/housing_information/get_list?";
														let param = {
					...
					if (json.result) {
						this.list_housing_information = json.result.list;
					}
				})
			},
		...
		mounted() {
								this.get_housing_information();
										this.get_menu();
			this.get_slides();
			this.get_notice();
		},
		computed: {
							    list_table_news_information() {
		        var list = this.list_housing_information;
		        var list_table = [];
		        for (let i = 0; i < list.length; i++) {
		            list_table[i] = {};
		            this.vm_arr_housing_information.map((o) => {
		                // 第二个中括号是对象的属性
