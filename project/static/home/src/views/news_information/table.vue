				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							...
							<table_news_information v-if="$check_action('/news_information/table','get')"></table_news_information>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_news_information from "../../components/diy/table_news_information.vue";
	export default {
		data() {
			return {
			};
