				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-md-9">
						<div class="card_addres pl-2">
							<!-- 租客用户 -->
							<div><span>租客用户</span></div>
							<table_tenant_user v-if="$check_action('/tenant_user/table','get')"></table_tenant_user>
						</div>
					</div>
				</div>
			</div>
...
<script>
	...
	import table_tenant_user from "../../components/diy/table_tenant_user.vue";
	export default {
		data() {
			return {
			};
