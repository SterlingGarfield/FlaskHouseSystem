      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/appointment_to_see_the_room/table','set') || $check_action('/appointment_to_see_the_room/view','set') || $check_action('/appointment_to_see_the_room/view','get')
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                        ...
                                        <!--跨表按钮-->
                  										<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small"  @click="to_table(scope.row,'/lease_contract/view')" v-if="($check_action('/lease_contract/table','add') || $check_action('/lease_contract/view','add')) && scope.row['examine_state'] == '已通过' && !scope.row['lease_contract_limit']">
					  <span>租赁合同</span>
					</el-button>
					                                                                        		  		  		  	<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="changeSigning(scope.row, scope.$index)" v-if="$check_option('/appointment_to_see_the_room/table', 'examine')">
		  		<span>审核</span>
		  	</el-button>
		        </template>
    </el-table-column>
