      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                      <el-button v-if="$check_action('/housing_information/table','add') || $check_action('/housing_information/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/housing_information/table','set') || $check_action('/housing_information/view','set') || $check_action('/housing_information/view','get')
      ...
      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
          ...
          <span>详情</span>
                                        ...
                                        <!--跨表按钮-->
                  										<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small"  @click="to_table(scope.row,'/appointment_to_see_the_room/view')" v-if="($check_action('/appointment_to_see_the_room/table','add') || $check_action('/appointment_to_see_the_room/view','add')) && scope.row['examine_state'] == '已通过' && !scope.row['appointment_to_see_the_room_limit']">
					  <span>在线预约</span>
					</el-button>
					                  										<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small"  @click="to_table(scope.row,'/financial_statements/view')" v-if="($check_action('/financial_statements/table','add') || $check_action('/financial_statements/view','add')) && scope.row['examine_state'] == '已通过' && !scope.row['financial_statements_limit']">
					  <span>财务报表</span>
					</el-button>
					                                                                                            <router-link v-if="$check_comment('/housing_information/table')" class="el-button el-button--small is-plain el-button--primary"
                             :to="'../comment/table?size=10&page=1&source_table=housing_information&source_field=' + field + '&source_id=' + scope.row[field]" size="small">
                  查看评论
                </router-link>
                                  		  		  		  	<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="changeSigning(scope.row, scope.$index)" v-if="$check_option('/housing_information/table', 'examine')">
		  		<span>审核</span>
		  	</el-button>
		        </template>
    </el-table-column>
