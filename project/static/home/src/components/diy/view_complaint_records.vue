	...
	export default {
	    ...
	    window.open(file.url)
			...
			async get_group_user_tenant_user() {
							this.form["tenant_user"] = this.$store.state.user.user_id;
          ...
          this.form["date_of_complaint"] = this.$toTime(parseInt(this.form["date_of_complaint"]),"yyyy-MM-dd")
			...
			get_obj_after(json, func){
																																																...
																																																if(json.result.obj["date_of_complaint"]=="0000-00-00"){
				  json.result.obj["date_of_complaint"] = null;
				}
				if(parseInt(json.result.obj["date_of_complaint"]) > 9999){
					json.result.obj["date_of_complaint"] = this.$toTime(parseInt(json.result.obj["date_of_complaint"]),"yyyy-MM-dd")
				}
