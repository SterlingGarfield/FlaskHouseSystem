      ...
      <el-row class="rows row2">
         ...
         <el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
                ...
                <el-button @click="reset()" style="margin-right: 74px;" class="search_btn_reset">重置</el-button>
                                                      <el-button v-if="$check_action('/tenant_user/table','add') || $check_action('/tenant_user/view','add')" @click="$router.push('./view?')" class="add">添加</el-button>
			<el-button @click="batchInfo()" class="examine_btn_state">批量审核</el-button>
            <el-button v-if="$check_action('/tenant_user/table','del') || $check_action('/tenant_user/view','del')" class="search_btn_del" type="danger" @click="delInfo()">删除</el-button>
                        </el-col>
      ...
      <el-table-column sortable prop="update_time" label="更新时间" min-width="200">
        <template slot-scope="scope">
          {{ $toTime(scope.row["update_time"],"yyyy-MM-dd hh:mm:ss") }}
                ...
                <el-table-column fixed="right" label="操作" min-width="120" v-if="$check_action('/tenant_user/table','set') || $check_action('/tenant_user/view','set') || $check_action('/tenant_user/view','get')
					 ">
        

      <template slot-scope="scope">
        <router-link class="el-button el-button--small is-plain el-button--success" style="margin: 5px !important;"
                     v-if="$check_action('/tenant_user/table','set') || $check_action('/tenant_user/view','set') || $check_action('/tenant_user/view','get')"
  ...
  import mixin from "@/mixins/page.js";
    ...
    data() {
      return {
        ...
        showModal: false,
        // 获取数据地址
        url_get_list: "~/api/tenant_user/get_list?like=0",
        url_del: "~/api/tenant_user/del?",
