	    ...
	    window.open(file.url)
          ...
          this.form["statistical_time"] = this.$toTime(parseInt(this.form["statistical_time"]),"yyyy-MM-dd")
			...
			get_obj_after(json, func){
																											...
																											if(json.result.obj["statistical_time"]=="0000-00-00"){
				  json.result.obj["statistical_time"] = null;
				}
				if(parseInt(json.result.obj["statistical_time"]) > 9999){
					json.result.obj["statistical_time"] = this.$toTime(parseInt(json.result.obj["statistical_time"]),"yyyy-MM-dd")
				}
