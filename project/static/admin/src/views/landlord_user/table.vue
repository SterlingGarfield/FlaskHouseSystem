	...
	<el-row class="rows row2">
		...
		<el-col :xs="24" :sm="24" :lg="24" class="search_btn_wrap search_btns">
				...
				<el-col :xs="24" :sm="10" :lg="8" class="search_btn_1 search_btn_wrap_1 btns">
						...
						<el-button v-if="$check_action('/landlord_user/table','add') || $check_action('/landlord_user/view','add')" @click="$router.push('./view?')">添加</el-button>
			...
			<el-table-column fixed="right" label="操作" min-width="200" v-if="$check_action('/landlord_user/table','set') || $check_action('/landlord_user/view','set') || $check_action('/landlord_user/view','get') 
						" >
				...
				<template slot-scope="scope">
					...
					<el-button class="e-button el-button--small is-plain el-button--primary" style="margin: 5px !important;" size="small" @click="changeSigning(scope.row, scope.$index)" v-if="$check_option('/landlord_user/table', 'examine')">
						<span>审核</span>
					</el-button>
				</div>
				</template>
