					...
					<el-form :model="form" ref="form" label-width="80px" class="form">
						...
						<el-form-item label="身份" prop="user_group">
							<el-select v-model="form.user_group" placeholder="身份">
								...
								<!-- 房东用户 -->
						<form_landlord_user v-if="form.user_group === '房东用户'" :form="form_sub" ></form_landlord_user>
...
<script>
	import mixin from "@/mixins/page.js";
			/* 房东用户 */
	import form_landlord_user from "@/components/diy/form_landlord_user";
		...
		methods: {
			...
			submit_before(param){
				var user_group = param.user_group;
						if(user_group === "房东用户"){
														param["name_of_landlord"] = param["name_of_landlord"] ? param["name_of_landlord"] : this.$get_stamp();
